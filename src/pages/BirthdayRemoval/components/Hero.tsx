      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-serif mb-6">
            Ta bort uppgifter från Birthday.se
          </h1>
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
            Du kan begära borttagning av dina personuppgifter från Birthday.se genom att kontakta deras kundservice via e-post.
          </p>
          <div className="mt-8">
            <a 
              href="https://www.birthday.se"
              target="_blank"
